...
{
    // Fetching rooms based on availability and guests
    ...
    while($room_data = mysqli_fetch_assoc($room_res))
    {
        ...
        if(count($facility_list['facilities'])!=$fac_count){
            continue; // Skip this room if it doesn't match the selected facilities
        }
        ...
        $output.="
            ...
            <div class='row g-0 p-3 align-items-center'>
             <div class='col-md-5 mb-lg-0 mb-md-0 mb-3'>
                ...
                <p class='mb-2 text-dark '>Rooms available: $room_data[quantity]</p>
                $book_btn

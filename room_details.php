    ...
    <div class="row">
      ...
      <div class="col-12 my-5 mb-4 px-4">
        ...
        <div class="font-size: 14px;">
          ...
          <span class="text-secondary"> > </span>
          <span class="text-secondary">MORE DETAILS</span>
        </div>
      </div>
        ...
        <div>
          ...
          <div>
           <div class="d-flex align-items-center mb-2">
            ...
            <p>
            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Minus provident,Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et, pariatur!
            </p>
            <div class="rating">
              <i class="bi bi-star-fill text-warning"></i>
              <i class="bi bi-star-fill text-warning"></i>
